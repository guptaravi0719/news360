...
void main() {
  ...
  setUpAll(() {
    articleJson = {
      ...
      'source': {
        'name': 'toolsfortools.com',
      },
      'url': 'https://toolsfortools.com',
      'urlToImage': null,
  ...
  group('Missing parts of the article.', () {
    testWidgets(
        'Article screen displays image placeholder if image is missing.',
    ...
    testWidgets(
        'Article-screen displays title placeholder if title is missing.',
        (WidgetTester tester) async {
  ...
  testWidgets('Article-screen handles category correctly',
      (WidgetTester tester) async {
    final fakeArticle = ArticleModel.fromJson(articleJson);
